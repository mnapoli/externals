...
class DbCommand
{
    ...
    public function setup(bool $force, OutputInterface $output): void
    {
        ...
        $this->db->transactional(function () use ($migrationQueries, $force, $output): void {
    ...
    public function truncate(bool $force, OutputInterface $output): void
    {
        $tables = $this->db->getSchemaManager()->listTableNames();
